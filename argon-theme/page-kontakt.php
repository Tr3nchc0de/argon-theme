      ...
      <div class="container">
          <div class="row">
            <div class="col-sm-6 col-md-4 p-4">
              <img class="img-fluid rounded-circle mx-auto d-block img-overlay" src="/wp-content/themes/wp-theme/public/img/reception.jpg" alt="Card image cap">
            </div>
            <div class="col-sm-6 col-md-7 p-4">
              <h3 class="head-dash-sub">Adresse</h3>
              <ul class="wpt-contact">
                <li><h3>Lungenfachärtztliche Gemeinschaftspraxis</h3></li>
                <li><h5>Gesundheitsforum an den Arcaden</h5></li>
                <li><ol class="wpt-contact-address"><li>Paracelsusstrasse 2</li></li>93053 Regensburg</li><li>Deutschland</li></ol></li>
                <li><i class="fa fa-phone"></i><a href="tel:+499415956090"> (0941) 59 56 09 - 0</a></li>
                <li><i class="fa fa-fax"></i><a href=""> (0941) 59 56 09 - 99</a></li>
                <li><i class="fa fa-envelope"></i><a href="mailto:kontakt@lungenfacharzt-regensburg.de"> kontakt@lungenfacharzt-regensburg.de</a></li>
                <li><i class="fa fa-globe"></i><a href="http://www.lungenfacharzt-regensburg.de"> www.lungenfacharzt-regensburg.de</a></li>
